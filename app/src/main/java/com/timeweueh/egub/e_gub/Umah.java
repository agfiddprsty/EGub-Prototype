...
public class Umah extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(checkInternet()) {
            ...
            webView.setWebViewClient(new Umah.MyWebViewClient());
        }else{
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent home =new Intent(Umah.this, Umah.class);
            startActivity(home);
            // Handle the camera action
        } else if (id == R.id.nav_polling){
            Intent vote = new Intent(Umah.this,Main3Activity.class);
            startActivity(vote);
            ...
            Intent login = new Intent(Umah.this, MainActivity.class);
            startActivity(login);
        } else if (id == R.id.nav_game) {
            Intent game = new Intent(Umah.this, Polling.class);
            startActivity(game);
        } else if (id == R.id.masalah) {
            Intent masalah = new Intent(Umah.this, Pengaduan.class);
            startActivity(masalah);
        } else if (id == R.id.nav_about) {
            Intent about = new Intent(Umah.this, Abou.class);
            startActivity(about);
        }
